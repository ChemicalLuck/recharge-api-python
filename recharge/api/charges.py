...
type ChargeStatus = Literal[
    "SUCCESS", "QUEUED", "ERROR", "REFUNDED", "PARTIALLY_REFUNDED", "SKIPPED"
]


class ChargeListQuery(TypedDict):
    address_id: str
    created_at_max: str
    created_at_min: str
    customer_id: str
...
class ChargeCountQuery(TypedDict):
    address_id: str
    customer_id: str
    date: str
    date_max: str
...
type ChargeSkipBody = ChargeSkipSubscriptionId | ChargeSkupSubscriptionIds


class ChargeRefundBody(TypedDict):
    amount: Required[str]
    full_refund: bool
...
class ChargeResource(RechargeResource):
    ...
    def get(self, charge_id: str):
        ...
        return self.http_get(f"{self.url}/{charge_id}")
    ...
    def change_next_charge_date(
        ...
        return self.http_put(f"{self.url}/{charge_id}/change_next_charge_date", body)
    ...
    def skip(self, charge_id: str, body: ChargeSkipBody):
        ...
        return self.http_post(f"{self.url}/{charge_id}/skip", body)
    ...
    def capture(self, charge_id: str):
        ...
        return self.http_post(f"{self.url}/{charge_id}/capture_payment", None)
